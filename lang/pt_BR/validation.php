...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'end'                       => 'fim',
        'order_items'               => 'item',
        'order_items.*.description' => 'descrição do item',
        'order_items.*.value'       => 'valor do item',
        'order_items.*.quantity'    => 'quantidade do item',
    ],

    'search_min_length'    => 'Digite 3 caracteres ou mais',

    'custom'               => [
        'start'            => [
            'past'         => 'O horário de início não pode estar no passado.',
        ],
        'end'              => [
            'before_start' => 'O horário de término deve ser depois do início.',
        ],
    ],
];
